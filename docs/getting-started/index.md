...
This section is the fastest path to a usable Moonin workspace. It covers cluster onboarding, Helm installation, the first dashboards to open, and how the current product surface is organized.
...
- The `moonin-agent` Helm chart installed with the shared credentials secret
...
- Access to the main Moonin views for overview metrics, errors, revisions, clusters, nodes, images and CronJobs
