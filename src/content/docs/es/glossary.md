...
**Organización**
: Cuenta principal de Moonin que contiene usuarios, proyectos, clusters y canales de notificación.

**Proyecto**
: Agrupación lógica usada para ordenar clusters y workloads.
...
: Destino de entrega administrado por la organización, como Slack o Teams.
