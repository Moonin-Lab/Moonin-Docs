...
Users do not call the cluster-facing APIs directly from the browser. `portal.moonin.app` and `admin.moonin.app` sit behind server-side application boundaries and enforce user scope there, while the agents authenticate as clusters.
